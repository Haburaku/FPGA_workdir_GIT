...
//  input           trig_n,
 ...
 // output          spi_csn_dac,
  ...
  assign spi_csn_dac = (1'd1); // spi_csn[1];
  assign spi_csn_clk = (1'd1); // spi_csn[0];
...
//    .O (trig));
  ...
  assign gpio_i[43:43] = (1'd0);    //trig; No external trigger on AD9694EBZ
...
//    .tx_data_3_p (tx_data_p[3]),
    ...
    .tx_sync_0 (1'd0),   //(tx_sync),
    .tx_sysref_0 (1'd0));       //(tx_sysref));
